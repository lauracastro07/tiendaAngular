...
class AudiclienteController {
    ...
    lista(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const audicliente = yield database_1.default.query('SELECT * FROM audicliente');
    ...
    buscar(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const audicliente = yield database_1.default.query(query, [id]);
...
exports.default = audiclienteController; //importando la instancia
