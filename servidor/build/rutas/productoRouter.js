...
class ProductoRoutes {
    ...
    config() {
        ...
        this.router.put('/:rfc', productoController_1.default.actualiza);
        this.router.delete('/:rfc', productoController_1.default.borrar);
        this.router.get('/:rfc', productoController_1.default.buscar);
    }
}
